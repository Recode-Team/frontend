...
let doc;
export function useMultiplayerState(roomId, userName) {
    ...
    const onChangePage = useThrottleCallback((app, shapes, bindings) => {
        if (!app || client === undefined || doc === undefined)
            return;
        doc.update((root) => {
    ...
    const onChangePresence = useThrottleCallback((app, user) => {
        if (!app || client === undefined || !client.isActive())
            return;
    ...
    useEffect(() => {
        ...
        function handleDisconnect() {
            if (client === undefined || doc === undefined)
                return;
            client.detach(doc);
            client.deactivate();
        }
        ...
        function handleChanges() {
            ...
            app === null || app === void 0 ? void 0 : app.replacePageContent(shapeRecord, bindingRecord, assetRecord);
        }
        let stillAlive = true;
        ...
        async function setupDocument() {
            try {
                ...
                const options = {
                    ...
                    presence: {
                        user: app === null || app === void 0 ? void 0 : app.currentUser,
                    },
                    syncLoopDuration: 0,
                    reconnectStreamDelay: 1000,
                };
                client = new yorkie.Client(`${process.env.REACT_APP_YORKIE_RPC_ADDR}`, options);
                ...
                client.subscribe((event) => {
                    if (event.type === 'peers-changed') {
                        ...
                        leavedUsers.forEach((user) => {
                            app === null || app === void 0 ? void 0 : app.removeUser(user.id);
                        });
                        // Then update users
                        app === null || app === void 0 ? void 0 : app.updateUsers(remoteUsers);
                    }
                });
